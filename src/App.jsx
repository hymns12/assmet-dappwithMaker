...
import haerdleVoteFunction from "./functions/heardleVoteFunctions";
import {
    useWeb3ModalAccount,
...
function App() {
    ...
    const heardleVote = async (id)  => {
        const data  = await haerdleVoteFunction(id, chainId, walletProvider);
        // console.log(heardleVote, data);
        console.log(id, chainId, walletProvider)
    }
    return (
        <Container>
            <Header />
